...
-- Modify table NCI_LAB_MAPING by increasing size of column TEST_CODE from 12 to 30
ALTER TABLE NCI_LAB_MAPPING MODIFY TEST_CODE VARCHAR2(30);

-- Modify table NCI_LABS by increasing size of column TEST_CODE from 12 to 30
ALTER TABLE NCI_LABS MODIFY TEST_CODE VARCHAR2(30);
